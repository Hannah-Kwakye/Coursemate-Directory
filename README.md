# Python Course Mate Directory : Summer 2024

Build a Course Mate Directory with Python (Flask) and JavaScript (React)
...
-   ✅ CRUD Functionality: Seamlessly create, read, update, and delete course mates from your directory.
